              ...
              <div className="flex flex-col gap-8">
                 <div className="flex items-center gap-6 group">
                    ...
                    <div>
                      ...
                      <a href="mailto:settleedgelegal@gmail.com" className="text-xl font-black text-slate-900 hover:text-indigo-600 transition-colors">settleedgelegal@gmail.com</a>
                    </div>
                 </div>
                 <div className="flex items-center gap-6 group">

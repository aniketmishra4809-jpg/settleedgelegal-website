          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 mb-8 shadow-sm">
                ...
                <span className="text-[10px] font-black text-indigo-700 uppercase tracking-[0.2em]">Fin-Tech Innovation Platform</span>
              </div>
            ...
            <div className="relative hidden lg:block">
              <div className="relative z-10 p-6 bg-white border border-slate-100 rounded-[3rem] shadow-2xl">
                 <AiImage prompt="Abstract 3D architectural render, vibrant glowing neon indigo and rose lines, modern luxury finance" className="w-full h-full rounded-[2.5rem]" aspectRatio="4:3" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                key={i}
                whileHover={{ y: -10 }}
                className="p-10 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm hover:shadow-2xl hover:shadow-indigo-100/50 transition-all duration-500 group"
              >
                ...
                <Link to="/process" className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest flex items-center gap-2">
                  View Flow <span className="opacity-0 group-hover:opacity-100 transition-all duration-300">→</span>
                </Link>
              </motion.div>
            ))}
          </div>

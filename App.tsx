        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <Link to="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 bg-slate-950 rounded-xl flex items-center justify-center transform group-hover:scale-105 transition-transform shadow-lg shadow-indigo-100">
              ...
              <div className="flex flex-col leading-none">
                <span className="text-xl font-black tracking-tighter text-slate-950 uppercase">
                  Settle<span className="text-indigo-600">Edge</span>
                </span>
                <span className="text-[8px] font-black uppercase tracking-[0.4em] text-slate-400 mt-1">Legal Services</span>
              </div>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="text-lg font-extrabold tracking-tighter text-white uppercase">
                  Settle<span className="text-indigo-400">Edge</span>
                </span>
              </div>
              ...
              <div className="space-y-4 text-xs font-semibold tracking-wide text-indigo-400">
                <a href="mailto:settleedgelegal@gmail.com" className="flex items-center gap-3 hover:text-white transition-colors">
                  <span className="p-2 bg-white/5 rounded-lg text-white">@</span> settleedgelegal@gmail.com
                </a>
            ...
            <div className="bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed italic">
                SettleEdge Legal operates strictly as a consultancy. We are not a lender or recovery agent. Professional representation is facilitated through our advocate panel.
              </p>
            </div>
          </div>
